        ...
        <div class="flex flex-wrap p-16 bg-neutral-100 shadow-2xl border-2 border-gray-200">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="flex align-start">
                    ...
                    <p class="text-gray-500 underline ">toomsaluraiko@gmail.com</p>
                    <p class="text-gray-500 underline ">lebrabusiness@gmail.com</p>
                    <p class="text-gray-500 underline">aitfredy@gmail.com</p>
                    </div>
                </div>
                </div>
